...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='StereoSA_confidence')
    parser.add_argument('--model', default='StereoSA_confidence', help='select a model structure', choices=__models__.keys())
    ...
    parser.add_argument('--loadckpt', default='./checkpoint/StereoSA_sceneflow_confidence.ckpt', help='load the weights from a specific checkpoint')
    ...
    model = __models__[args.model](args.maxdisp, device)
