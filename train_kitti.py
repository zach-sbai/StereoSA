...
parser.add_argument('--datapath_v', default="/datasets/vkitti/", help='data path')
...
parser.add_argument('--loadckpt', default='./checkpoint/vkitti_best.ckpt', help='load the weights from a specific checkpoint')
...
if args.dataset == "vkitti":
    train_dataset = StereoDataset(args.datapath_v, args.trainlist, True)
